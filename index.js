...
let displayGrammar = numUnfunded !== 1 ? 'games remain' : 'game remains';
const displayStr = 
    `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length}
     games. Currently, ${numUnfunded} ${displayGrammar} unfunded. We need your help to fund these amazing games!`
...
const sndPledgeGame = document.createElement('p');
sndPledgeGame.textContent = secondGame.name;
secondGameContainer.appendChild(sndPledgeGame);